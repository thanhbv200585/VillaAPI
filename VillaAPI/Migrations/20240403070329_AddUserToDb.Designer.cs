...
namespace VillaAPI.Migrations
{
    ...
    [Migration("20240403070329_AddUserToDb")]
            ...
            modelBuilder.Entity("VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 3, 4, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1597),
                            ...
                            Rate = 5.0,
                            Sqft = 3000,
                            UpdatedDate = new DateTime(2024, 3, 29, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1614)
                        },
                        new
                        {
                            Id = 2,
                            Amenity = "Garden, BBQ, Beach access",
                            CreatedDate = new DateTime(2024, 3, 9, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1618),
                            ...
                            Rate = 4.0,
                            Sqft = 2500,
                            UpdatedDate = new DateTime(2024, 3, 31, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1619)
                        },
                        new
                        {
                            Id = 3,
                            Amenity = "Fireplace, Hiking trails",
                            CreatedDate = new DateTime(2024, 3, 14, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1620),
                            ...
                            Rate = 3.0,
                            Sqft = 2000,
                            UpdatedDate = new DateTime(2024, 4, 1, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1621)
                        },
                        new
                        {
                            Id = 4,
                            Amenity = "Children's playground, Game room",
                            CreatedDate = new DateTime(2024, 3, 19, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1622),
                            ...
                            Rate = 3.5,
                            Sqft = 2200,
                            UpdatedDate = new DateTime(2024, 4, 2, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1623)
                        },
                        new
                        {
                            Id = 5,
                            Amenity = "Swimming pool, Gym, Smart home features",
                            CreatedDate = new DateTime(2024, 3, 24, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1624),
                            ...
                            Rate = 4.5,
                            Sqft = 2800,
                            UpdatedDate = new DateTime(2024, 4, 3, 14, 3, 28, 511, DateTimeKind.Local).AddTicks(1625)
                        });
                });
